...
<cffunction name="draw">
	...
	<cfset sReturn = '<label for="#arguments.htmlid##arguments.fieldName#">#getLabel(arguments.fieldName)#</label><div><input type="date" name="f-#arguments.formfieldid#"  id="#arguments.htmlid##arguments.fieldName#" value="#dateformat(arguments.value,"yyyy-mm-dd")#" #drawReadonly(arguments.readonly)# #drawRequired(arguments.required)# placeholder="#arguments.placeholder#" ></div>'>
