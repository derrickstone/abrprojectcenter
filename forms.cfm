...
<cfinvoke component="#application.modelpath#.form" method="getData" returnvariable="qForms" ladditionalfields="formstatus"></cfinvoke>

<cfinvoke component="#application.modelpath#.form" method="showEditingList" returnvariable="sEditFormList" qData="#qForms#" maxitems="#application.maxforms#"></cfinvoke>
<cfoutput>#sEditFormList#</cfoutput>
